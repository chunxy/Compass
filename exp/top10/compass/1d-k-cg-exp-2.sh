...
/home/chunxy/repos/Compass/build/Release/src/benchmarks/bench-compass-1d-k-cg --datacard ${dataset}_1_10000_float32 --l 100 --r 4100 --k 10 --M ${M} --efc ${efc} --nlist ${nlist} --efs ${efs_s[@]} --nrel ${nrel_s[@]}
/home/chunxy/repos/Compass/build/Release/src/benchmarks/bench-compass-1d-k-cg --datacard ${dataset}_1_10000_float32 --l 100 --r 5100 --k 10 --M ${M} --efc ${efc} --nlist ${nlist} --efs ${efs_s[@]} --nrel ${nrel_s[@]}
/home/chunxy/repos/Compass/build/Release/src/benchmarks/bench-compass-1d-k-cg --datacard ${dataset}_1_10000_float32 --l 100 --r 6100 --k 10 --M ${M} --efc ${efc} --nlist ${nlist} --efs ${efs_s[@]} --nrel ${nrel_s[@]}
