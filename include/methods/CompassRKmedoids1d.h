...
class CompassRKmedoids1d {
 ...
 public:
  CompassRKmedoids1d(size_t d, size_t M, size_t efc, size_t max_elements, size_t nlist);
...
template <typename dist_t, typename attr_t>
CompassRKmedoids1d<dist_t, attr_t>::CompassRKmedoids1d(size_t d, size_t M, size_t efc, size_t max_elements, size_t nlist)
    : space_(d),
...
template <typename dist_t, typename attr_t>
int CompassRKmedoids1d<dist_t, attr_t>::AddPoint(const void *data_point, labeltype label, attr_t attr) {
...
template <typename dist_t, typename attr_t>
int CompassRKmedoids1d<dist_t, attr_t>::AddGraphPoint(const void *data_point, labeltype label) {
  hnsw_.addPoint(data_point, label, -1);
  return 1;
}

template <typename dist_t, typename attr_t>
int CompassRKmedoids1d<dist_t, attr_t>::AddIvfPoints(size_t n, const void *data, labeltype *labels, attr_t *attr) {
...
template <typename dist_t, typename attr_t>
void CompassRKmedoids1d<dist_t, attr_t>::TrainIvf(size_t n, const void *data) {
