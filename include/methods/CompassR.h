...
class CompassR {
 ...
 public:
  CompassR(size_t d, size_t M, size_t efc, size_t max_elements, size_t nlist, size_t nrel, size_t nbits);
...
template <typename dist_t, typename attr_t>
CompassR<dist_t, attr_t>::CompassR(
    size_t d,
    size_t M,
    size_t efc,
    size_t max_elements,
...
template <typename dist_t, typename attr_t>
int CompassR<dist_t, attr_t>::AddIvfPoints(size_t n, const void *data, labeltype *labels, const vector<vector<attr_t>> &attrs) {
