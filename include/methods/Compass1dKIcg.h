...
class Compass1dKIcg : public Compass1dIcg<dist_t, attr_t> {
 public:
  Compass1dKIcg(size_t n, size_t d, size_t M, size_t efc, size_t nlist, const string &path, size_t batch_k, size_t delta_efs)
      : Compass1dIcg<dist_t, attr_t>(n, d, M, efc, nlist, path, batch_k, delta_efs) {
