...
#include "config.h"
#include "json.hpp"
#include "methods/Compass1dPostK.h"
#include "utils/Pod.h"
...
int main(int argc, char **argv) {
  ...
  std::string method = "CompassPostKNavix";
  ...
  Compass1dPostK<float, float> comp(
      nb, d, args.M, args.efc, args.nlist, args.M_cg, args.batch_k, args.initial_efs, args.delta_efs
  );
...
// #pragma omp taskloop
      ...
      for (int j = 0; j < nq; j += args.batchsz) {
        ...
        results[b] = comp.SearchKnnPostFilteredNavix(
            xq + j * d,
            args.batchsz,
            args.k,
            attrs.data(),
