...
int main(int argc, char **argv) {
  ...
  CompassKIcg<float, float> comp(
      nb, d, new L2Space(d), c.attr_dim, args.M, args.efc, args.nlist, args.M_cg, args.batch_k, args.delta_efs
  );
