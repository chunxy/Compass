...
compass_args = {
  ...
  "efs": [10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 70, 75, 80, 90, 100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 250, 260, 270, 280, 290, 300],
  "nrel": [50, 100],
  "dx": [64, 128, 256, 512],
  "M_cg": [4],
  "batch_k": [50],
...
irangegraph_args = {
  "M": [16, 32],
  "efc": [200],
  "efs": [10, 15, 20, 25, 30, 35, 40, 50, 60, 70, 80, 90, 100, 120, 140, 160, 180, 200, 250, 300, 350, 400, 450, 500, 600, 700, 800, 900, 1000],
}
serf_args = {
  "M": [16, 32],
  "efc": [200],
...
navix_args = {
  "M": [16],
  "efc": [200],
  "efs": [10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 70, 75, 80, 90, 100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 250, 260, 270, 280, 290, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500],
}
acorn_args = {
  "M": [32],
  "beta": [64],
